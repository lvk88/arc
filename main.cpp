...
PViewDataList *Img2Data(const CustomImage& customImage)
{
...
CustomImage read_lvk88(const std::string& fileName)
{
  ...
  return CustomImage{w, h, img_data};
}
